...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        ...
        mainPanel(
            ...
            tabPanel("Help",br(),"Welcome to the application.",br(), "Use the slider to change population value",br(),
                     "The application will display the estimated Unemployment for that value",br(),
                     ...
                     "Next, click on the Output tab to display the results.",br(),
                     "You may return to the slider to do further calculations as desired.") ,           
            tabPanel("Output" ,
            plotOutput("plot1"),
